...
layout: post
title: TEST EX.
description: hell yeah it's a project!
...
<div class="img_row">
	...
	<img class="col one" src="{{ site.baseurl }}{{ project.img }}/img/portfolio/SuperBloom/bell-preview02.jpg" alt="" title="example image"/>
